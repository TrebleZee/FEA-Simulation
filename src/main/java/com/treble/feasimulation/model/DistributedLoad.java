...
public class DistributedLoad {
    ...
    private final double wx; // Distributed load in x-direction (N/m)
    private final double wy; // Distributed load in y-direction (N/m)
    ...
    public String toString() {
        return "DistributedLoad{" + id + ": polygon=" + polygonId + ", edge=" + edgeIndex + ", (" + wx + "," + wy + ")}";
    }
}
