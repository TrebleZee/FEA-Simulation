...
public final class MaterialLibrary {
    private static final Material STEEL = new Material(1, "Steel", 2.0e11, 7850.0, 2.5e8);
    private static final Material ALUMINIUM = new Material(2, "Aluminium", 6.9e10, 2700.0, 1.5e8);
    private static final Material WOOD = new Material(3, "Wood", 1.0e10, 600.0, 4.0e7);
